    ...
    <main class="container">
        ...
        <div class="cart-wrapper">
            ...
            <div class="cart-summary">
                ...
                <h4 style="margin-top: 2rem;">Detail Pengiriman</h4>

                @if ($errors->any())
                <div style="background-color: #fdd; color: #a00; padding: 10px; border: 1px solid #f00; border-radius: 4px; margin-bottom: 1rem;">
                    Silakan lengkapi Nama dan Nomor WhatsApp Anda.
                </div>
                @endif
                ...
                <form action="{{ route('cart.process') }}" method="POST">
                    ...
                    <div style="margin-bottom: 1rem;">
                        <label for="customer_name" style="display: block; font-size: 0.9em; margin-bottom: 0.3rem;">Nama Lengkap:</label>
                        <input type="text" name="customer_name" id="customer_name" class="input-full-width"
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        <label for="customer_phone" style="display: block; font-size: 0.9em; margin-bottom: 0.3rem;">Nomor WhatsApp:</label>
                        <input type="text" name="customer_phone" id="customer_phone" class="input-full-width"
