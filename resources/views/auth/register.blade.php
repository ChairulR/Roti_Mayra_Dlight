    ...
    <div class="auth-card">
        ...
        <form action="{{ route('register.post') }}" method="POST">
            ...
            <div style="display:flex;gap:.5rem;align-items:center">
                ...
                <button type="button" data-toggle="password" data-target="password_confirmation" class="btn" style="background:#eee;color:#333;border-radius:6px;padding:.5rem">Tampilkan</button>
            </div>
