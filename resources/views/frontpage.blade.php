                ...
                <div class="swiper-slide"
                    ...
                    <a href="{{ route('breads.show', $b->id) }}">
                        ...
                        <img src="{{ asset('storage/' . $b->image) }}"
                            ...
                            alt="Promosi {{ $b->name }}">
                        @else
                        <div style="width:100%; height:100%; background: #e0d1b3; display: flex; align-items: center; justify-content: center;">
                            <h3 class="text-white">PROMOSI: {{ $b->name }}</h3>
                        </div>
                        @endif

                        {{-- Teks/Judul Overlay --}}
                        <div style="position: absolute; bottom: 20px; left: 20px; color: white; text-shadow: 1px 1px 3px rgba(0,0,0,0.7);">
                            <h2 style="margin-bottom: 5px;">⭐ PROMO HARI INI: {{ strtoupper($b->name) }}</h2>
                            <p style="font-size: 1rem;">Klik untuk melihat detail dan diskon spesial!</p>
                        </div>
                    </a>
                </div>
                @empty
                <div class="swiper-slide">
                    <div style="width:100%; height:100%; background: #f5f5f5; display: flex; align-items: center; justify-content: center; color: #888;">
                        <h3 style="font-weight: normal;">Tidak Ada Menu yang Dipromosikan Saat Ini.</h3>
                    </div>
                </div>
                @endforelse
            </div>
